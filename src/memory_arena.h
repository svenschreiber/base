...
static Mem_Arena mem_arena_init_with_align(u64 align, u64 size) {
    Mem_Arena arena = {0};
...
static Mem_Arena mem_arena_init(u64 size) {
    return mem_arena_init_with_align(MEM_ARENA_ALIGN_DEFAULT, size);
}

static void * mem_arena_push(Mem_Arena *arena, u64 size) {
    void *mem = 0;
...
static void mem_arena_pop(Mem_Arena *arena, u64 size) {
...
static void mem_arena_release(Mem_Arena *arena) {
