...
static void win32_load_wgl_functions() {
...
static void win32_create_opengl_context(HGLRC *gl_rc, HDC window_dc) {
    ...
    int pixel_format = ChoosePixelFormat(window_dc, &dummy_pfd);
    if (pixel_format) {
